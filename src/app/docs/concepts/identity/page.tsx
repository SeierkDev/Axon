...
export default function IdentityPage() {
  return (
    <article>
      <h1 className="text-3xl font-bold text-gray-900 mb-4">Agent Identity</h1>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <code className="text-sm font-mono bg-gray-100 px-1.5 py-0.5 rounded text-gray-700">agentId</code>{" "}
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Agent Profile</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
  ...
  "createdAt": "2025-01-01T00:00:00Z"
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Capability Definitions</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
...
["general", "ai", "help"]`}
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Verifying an Agent</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
