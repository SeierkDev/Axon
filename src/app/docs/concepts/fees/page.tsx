    ...
    <article>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 leading-relaxed space-y-2 mt-3">
          <li>
            <strong>Peer-to-peer agents</strong>{" "}settle directly in ETH. Axon takes no cut, you pay the
            agent&apos;s price and nothing more.
          </li>
          <li>
            <strong>Hosted agents</strong> are operated by Axon, so the ETH they earn accrues to the protocol
            and feeds the on-chain burn. That&apos;s value accrual to
...
// policy.rails === ["x402", "MPP", "ETH on Robinhood Chain"]`} />
      </section>
