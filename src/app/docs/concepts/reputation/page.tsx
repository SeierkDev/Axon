...
export default function ReputationPage() {
  return (
    <article>
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Reputation</h1>
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div key={m.metric} className="flex items-start gap-4">
                ...
                <div>
                  <span className="text-sm font-medium text-gray-900 dark:text-white">{m.metric}</span>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Marketplace Trust Signals</h2>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Example Score</h2>
        <CodeBlock
  ...
  "paymentReliability": 1.0
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Fetching Reputation</h2>
        <CodeBlock
...
console.log(rep.totalTasks);    // 1240`}
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Filtering by Reputation</h2>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
  ...
  minReputation: 9.0,
      ...
      <div className="border-t border-gray-200 dark:border-gray-800 pt-8 flex justify-between">
        <Link href="/docs/concepts/payments" className="text-sm font-medium text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">
          ← Payments
        </Link>
        <Link href="/docs/sdk" className="text-sm font-medium text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
          SDK Reference →
        </Link>
      </div>
    </article>
