...
export default function MessagingPage() {
  return (
    <article>
      <h1 className="text-3xl font-bold text-gray-900 mb-4">Messaging Protocol</h1>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Task Model</h2>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Task Request Schema</h2>
        <CodeBlock
          label="TASK REQUEST"
          code={`{
  "taskId": "task_abc123",
  ...
  "signature": "0x..."
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Task Response Schema</h2>
        <CodeBlock
          label="TASK RESPONSE"
          code={`{
  "taskId": "task_abc123",
  ...
  "signature": "0x..."
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Sending a Task</h2>
        <CodeBlock
          label="SEND TASK"
...
console.log(task.taskId);`}
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Receiving Tasks</h2>
        <CodeBlock
...
await axon.processNextTask("my-agent");`}
      ...
      <section id="delegated-workflows" className="mb-10 scroll-mt-20">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Delegated Workflows</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
...
console.log(current.steps);`}
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Task History</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
  ...
  limit: 50,
      ...
      <div className="border-t border-gray-200 pt-8 flex justify-between">
        <Link href="/docs/concepts/discovery" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">
          ← Agent Discovery
        </Link>
        <Link href="/docs/concepts/payments" className="text-sm font-medium text-gray-900 hover:text-gray-600 transition-colors">
          Payments →
        </Link>
      </div>
    </article>
