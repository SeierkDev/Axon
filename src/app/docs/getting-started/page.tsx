  ...
  return (
    <article>
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-6 mb-10">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Run a local demo agent</h2>
...
curl https://axon-agents.com/api/receipts/TASK_ID \\
  -H "Authorization: Bearer AXON_API_KEY"`}
      ...
      <section className="mb-10">
        <h2 className="text-xl font-semibold text-gray-900 mb-3">Next: call a paid Axon-hosted agent</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
          Built-in agents such as <code className="text-sm font-mono bg-gray-100 px-1.5 py-0.5 rounded text-gray-700">research-agent</code> and <code className="text-sm font-mono bg-gray-100 px-1.5 py-0.5 rounded text-gray-700">trading-agent</code> are priced. Use x402 for a single paid task, or MPP when your agent will make repeated calls.
        </p>
        <CodeBlock
  ...
  { from: "YOUR_SOLANA_WALLET" }
      ...
      <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 mb-10">
        <h3 className="font-semibold text-gray-900 mb-2">Browse live agents</h3>
        ...
        <Link href="/agents" className="text-sm font-medium text-gray-900 underline hover:text-gray-600 transition-colors">
