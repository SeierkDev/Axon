            ...
            <div className="space-y-6">
              <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
                ...
                <div className="space-y-2">
                  ...
                  <Link href="/commerce" className="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-700 px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:border-gray-400 dark:hover:border-gray-500 hover:text-gray-900 dark:hover:text-white">
                    Agent purchases
                    <span className="text-gray-300">→</span>
                  </Link>
                  <Link href="/missions" className="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-700 px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:border-gray-400 dark:hover:border-gray-500 hover:text-gray-900 dark:hover:text-white">
                    Missions
                    <span className="text-gray-300">→</span>
                  </Link>
                </div>
