  ...
  return (
    <div className="bg-white min-h-screen text-[#0a0a0a]">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-32 pb-24">
        <div className="mb-8">
          <p className="text-xs font-mono text-gray-400 tracking-wider mb-3">OWNER DASHBOARD</p>
          <h1 className="text-3xl font-bold text-gray-900 mb-3">Your Axon Control Panel</h1>
