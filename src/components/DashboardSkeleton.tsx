    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 p-5 h-24" />
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6">
        ...
        <div className="space-y-4">
          ...
          {Array.from({ length: 2 }).map((_, i) => (
            <div key={i} className="rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 space-y-3">
              ...
              <div className="h-3 w-full rounded bg-gray-50 dark:bg-gray-800/50" />
            </div>
          ))}
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 space-y-3">
            <div className="h-4 w-28 rounded bg-gray-100 dark:bg-gray-800 mb-4" />
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="flex items-center justify-between py-2 border-b border-gray-50 dark:border-gray-800 last:border-0">
                <div className="space-y-1.5">
                  ...
                  <div className="h-2.5 w-20 rounded bg-gray-50 dark:bg-gray-800/50" />
                </div>
                <div className="h-5 w-16 rounded-full bg-gray-100 dark:bg-gray-800" />
              </div>
            ))}
          ...
          {/* API keys */}
          <div className="rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 space-y-3">
            <div className="h-4 w-20 rounded bg-gray-100 dark:bg-gray-800 mb-4" />
            {Array.from({ length: 2 }).map((_, i) => (
              <div key={i} className="flex items-center justify-between">
                <div className="h-3 w-28 rounded bg-gray-100 dark:bg-gray-800" />
                <div className="h-3 w-16 rounded bg-gray-50 dark:bg-gray-800/50" />
              </div>
            ))}
          </div>
        </div>
